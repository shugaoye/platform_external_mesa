...
void APIENTRY shared_dispatch_stub_572(GLenum target, GLenum clamp);
void APIENTRY shared_dispatch_stub_573(GLenum mode, GLint first, GLsizei count, GLsizei primcount);
void APIENTRY shared_dispatch_stub_574(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount);
void APIENTRY shared_dispatch_stub_575(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
void APIENTRY shared_dispatch_stub_576(GLenum target, GLenum attachment, GLuint texture, GLint level);
void APIENTRY shared_dispatch_stub_577(GLenum target, GLenum attachment, GLuint texture, GLint level, GLenum face);
void APIENTRY shared_dispatch_stub_578(GLuint program, GLenum pname, GLint value);
void APIENTRY shared_dispatch_stub_579(GLuint index, GLuint divisor);
void APIENTRY shared_dispatch_stub_580(GLenum target, GLintptr offset, GLsizeiptr length);
GLvoid * APIENTRY shared_dispatch_stub_581(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
void APIENTRY shared_dispatch_stub_582(GLenum target, GLenum internalFormat, GLuint buffer);
void APIENTRY shared_dispatch_stub_583(GLuint array);
void APIENTRY shared_dispatch_stub_584(GLsizei n, GLuint *arrays);
void APIENTRY shared_dispatch_stub_585(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
GLenum APIENTRY shared_dispatch_stub_586(GLsync sync, GLbitfield flags, GLuint64 timeout);
void APIENTRY shared_dispatch_stub_587(GLsync sync);
GLsync APIENTRY shared_dispatch_stub_588(GLenum condition, GLbitfield flags);
void APIENTRY shared_dispatch_stub_589(GLenum pname, GLint64 *params);
void APIENTRY shared_dispatch_stub_590(GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values);
GLboolean APIENTRY shared_dispatch_stub_591(GLsync sync);
void APIENTRY shared_dispatch_stub_592(GLsync sync, GLbitfield flags, GLuint64 timeout);
void APIENTRY shared_dispatch_stub_593(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex);
void APIENTRY shared_dispatch_stub_594(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount, GLint basevertex);
void APIENTRY shared_dispatch_stub_595(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex);
void APIENTRY shared_dispatch_stub_596(GLenum mode, const GLsizei *count, GLenum type, const GLvoid **indices, GLsizei primcount, const GLint *basevertex);
void APIENTRY shared_dispatch_stub_597(GLuint buf, GLenum modeRGB, GLenum modeA);
void APIENTRY shared_dispatch_stub_598(GLuint buf, GLenum mode);
void APIENTRY shared_dispatch_stub_599(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcA, GLenum dstA);
void APIENTRY shared_dispatch_stub_600(GLuint buf, GLenum src, GLenum dst);
void APIENTRY shared_dispatch_stub_601(GLuint unit, GLuint sampler);
void APIENTRY shared_dispatch_stub_602(GLsizei count, const GLuint *samplers);
void APIENTRY shared_dispatch_stub_603(GLsizei count, GLuint *samplers);
void APIENTRY shared_dispatch_stub_604(GLuint sampler, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_605(GLuint sampler, GLenum pname, GLuint *params);
void APIENTRY shared_dispatch_stub_606(GLuint sampler, GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_607(GLuint sampler, GLenum pname, GLint *params);
GLboolean APIENTRY shared_dispatch_stub_608(GLuint sampler);
void APIENTRY shared_dispatch_stub_609(GLuint sampler, GLenum pname, const GLint *params);
void APIENTRY shared_dispatch_stub_610(GLuint sampler, GLenum pname, const GLuint *params);
void APIENTRY shared_dispatch_stub_611(GLuint sampler, GLenum pname, GLfloat param);
void APIENTRY shared_dispatch_stub_612(GLuint sampler, GLenum pname, const GLfloat *params);
void APIENTRY shared_dispatch_stub_613(GLuint sampler, GLenum pname, GLint param);
void APIENTRY shared_dispatch_stub_614(GLuint sampler, GLenum pname, const GLint *params);
void APIENTRY shared_dispatch_stub_615(GLenum target, GLuint id);
void APIENTRY shared_dispatch_stub_616(GLsizei n, const GLuint *ids);
void APIENTRY shared_dispatch_stub_617(GLenum mode, GLuint id);
void APIENTRY shared_dispatch_stub_618(GLsizei n, GLuint *ids);
GLboolean APIENTRY shared_dispatch_stub_619(GLuint id);
void APIENTRY shared_dispatch_stub_620(void);
void APIENTRY shared_dispatch_stub_621(void);
void APIENTRY shared_dispatch_stub_622(GLclampf depth);
void APIENTRY shared_dispatch_stub_623(GLclampf zNear, GLclampf zFar);
void APIENTRY shared_dispatch_stub_624(GLenum shadertype, GLenum precisiontype, GLint *range, GLint *precision);
void APIENTRY shared_dispatch_stub_625(void);
void APIENTRY shared_dispatch_stub_626(GLsizei n, const GLuint *shaders, GLenum binaryformat, const GLvoid *binary, GLsizei length);
void APIENTRY shared_dispatch_stub_627(GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary);
void APIENTRY shared_dispatch_stub_628(GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length);
void APIENTRY shared_dispatch_stub_629(GLuint program, GLenum pname, GLint value);
GLenum APIENTRY shared_dispatch_stub_630(void);
void APIENTRY shared_dispatch_stub_631(GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *table);
void APIENTRY shared_dispatch_stub_632(GLenum target, GLint lod, GLsizei bufSize, GLvoid *img);
void APIENTRY shared_dispatch_stub_633(GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *image);
void APIENTRY shared_dispatch_stub_634(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values);
void APIENTRY shared_dispatch_stub_635(GLenum target, GLenum query, GLsizei bufSize, GLdouble *v);
void APIENTRY shared_dispatch_stub_636(GLenum target, GLenum query, GLsizei bufSize, GLfloat *v);
void APIENTRY shared_dispatch_stub_637(GLenum target, GLenum query, GLsizei bufSize, GLint *v);
void APIENTRY shared_dispatch_stub_638(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values);
void APIENTRY shared_dispatch_stub_639(GLenum map, GLsizei bufSize, GLfloat *values);
void APIENTRY shared_dispatch_stub_640(GLenum map, GLsizei bufSize, GLuint *values);
void APIENTRY shared_dispatch_stub_641(GLenum map, GLsizei bufSize, GLushort *values);
void APIENTRY shared_dispatch_stub_642(GLsizei bufSize, GLubyte *pattern);
void APIENTRY shared_dispatch_stub_643(GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, GLvoid *row, GLsizei columnBufSize, GLvoid *column, GLvoid *span);
void APIENTRY shared_dispatch_stub_644(GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, GLvoid *img);
void APIENTRY shared_dispatch_stub_645(GLhandleARB program, GLint location, GLsizei bufSize, GLdouble *params);
void APIENTRY shared_dispatch_stub_646(GLhandleARB program, GLint location, GLsizei bufSize, GLfloat *params);
void APIENTRY shared_dispatch_stub_647(GLhandleARB program, GLint location, GLsizei bufSize, GLint *params);
void APIENTRY shared_dispatch_stub_648(GLhandleARB program, GLint location, GLsizei bufSize, GLuint *params);
void APIENTRY shared_dispatch_stub_649(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLvoid *data);
void APIENTRY shared_dispatch_stub_650(GLfloat factor, GLfloat bias);
void APIENTRY shared_dispatch_stub_651(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY shared_dispatch_stub_652(const GLfloat *coords);
void APIENTRY shared_dispatch_stub_653(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY shared_dispatch_stub_654(const GLint *coords);
void APIENTRY shared_dispatch_stub_655(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY shared_dispatch_stub_656(const GLshort *coords);
void APIENTRY shared_dispatch_stub_657(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY shared_dispatch_stub_658(const GLfixed *coords);
void APIENTRY shared_dispatch_stub_659(GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_660(GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_661(GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_662(GLenum pname, GLfloat param);
void APIENTRY shared_dispatch_stub_663(GLenum pname, const GLfloat *params);
void APIENTRY shared_dispatch_stub_664(GLenum pname, GLint param);
void APIENTRY shared_dispatch_stub_665(GLenum pname, const GLint *params);
GLbitfield APIENTRY shared_dispatch_stub_666(GLfixed *mantissa, GLint *exponent);
void APIENTRY shared_dispatch_stub_667(GLclampf value, GLboolean invert);
void APIENTRY shared_dispatch_stub_668(GLenum pattern);
void APIENTRY shared_dispatch_stub_669(GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_670(GLsizei stride, GLsizei count, const GLboolean *pointer);
void APIENTRY shared_dispatch_stub_671(GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_672(GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_673(GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_674(GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_675(GLenum pname, GLfloat param);
void APIENTRY shared_dispatch_stub_676(GLenum pname, const GLfloat *params);
void APIENTRY shared_dispatch_stub_677(GLint first, GLsizei count);
void APIENTRY shared_dispatch_stub_678(void);
void APIENTRY shared_dispatch_stub_679(GLbyte red, GLbyte green, GLbyte blue);
void APIENTRY shared_dispatch_stub_680(const GLbyte *v);
void APIENTRY shared_dispatch_stub_681(GLdouble red, GLdouble green, GLdouble blue);
void APIENTRY shared_dispatch_stub_682(const GLdouble *v);
void APIENTRY shared_dispatch_stub_683(GLfloat red, GLfloat green, GLfloat blue);
void APIENTRY shared_dispatch_stub_684(const GLfloat *v);
void APIENTRY shared_dispatch_stub_685(GLint red, GLint green, GLint blue);
void APIENTRY shared_dispatch_stub_686(const GLint *v);
void APIENTRY shared_dispatch_stub_687(GLshort red, GLshort green, GLshort blue);
void APIENTRY shared_dispatch_stub_688(const GLshort *v);
void APIENTRY shared_dispatch_stub_689(GLubyte red, GLubyte green, GLubyte blue);
void APIENTRY shared_dispatch_stub_690(const GLubyte *v);
void APIENTRY shared_dispatch_stub_691(GLuint red, GLuint green, GLuint blue);
void APIENTRY shared_dispatch_stub_692(const GLuint *v);
void APIENTRY shared_dispatch_stub_693(GLushort red, GLushort green, GLushort blue);
void APIENTRY shared_dispatch_stub_694(const GLushort *v);
void APIENTRY shared_dispatch_stub_695(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_696(GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount);
void APIENTRY shared_dispatch_stub_697(GLenum mode, const GLsizei *count, GLenum type, const GLvoid **indices, GLsizei primcount);
void APIENTRY shared_dispatch_stub_698(GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_699(GLdouble coord);
void APIENTRY shared_dispatch_stub_700(const GLdouble *coord);
void APIENTRY shared_dispatch_stub_701(GLfloat coord);
void APIENTRY shared_dispatch_stub_702(const GLfloat *coord);
void APIENTRY shared_dispatch_stub_703(GLenum mode);
void APIENTRY shared_dispatch_stub_704(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
void APIENTRY shared_dispatch_stub_705(void);
void APIENTRY shared_dispatch_stub_706(GLsizei length, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_707(GLenum stage, GLenum portion, GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
void APIENTRY shared_dispatch_stub_708(GLenum stage, GLenum portion, GLenum abOutput, GLenum cdOutput, GLenum sumOutput, GLenum scale, GLenum bias, GLboolean abDotProduct, GLboolean cdDotProduct, GLboolean muxSum);
void APIENTRY shared_dispatch_stub_709(GLenum pname, GLfloat param);
void APIENTRY shared_dispatch_stub_710(GLenum pname, const GLfloat *params);
void APIENTRY shared_dispatch_stub_711(GLenum pname, GLint param);
void APIENTRY shared_dispatch_stub_712(GLenum pname, const GLint *params);
void APIENTRY shared_dispatch_stub_713(GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
void APIENTRY shared_dispatch_stub_714(GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_715(GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_716(GLenum stage, GLenum portion, GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_717(GLenum stage, GLenum portion, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_718(GLenum variable, GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_719(GLenum variable, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_720(void);
void APIENTRY shared_dispatch_stub_721(GLdouble x, GLdouble y);
void APIENTRY shared_dispatch_stub_722(const GLdouble *v);
void APIENTRY shared_dispatch_stub_723(GLfloat x, GLfloat y);
void APIENTRY shared_dispatch_stub_724(const GLfloat *v);
void APIENTRY shared_dispatch_stub_725(GLint x, GLint y);
void APIENTRY shared_dispatch_stub_726(const GLint *v);
void APIENTRY shared_dispatch_stub_727(GLshort x, GLshort y);
void APIENTRY shared_dispatch_stub_728(const GLshort *v);
void APIENTRY shared_dispatch_stub_729(GLdouble x, GLdouble y, GLdouble z);
void APIENTRY shared_dispatch_stub_730(const GLdouble *v);
void APIENTRY shared_dispatch_stub_731(GLfloat x, GLfloat y, GLfloat z);
void APIENTRY shared_dispatch_stub_732(const GLfloat *v);
void APIENTRY shared_dispatch_stub_733(GLint x, GLint y, GLint z);
void APIENTRY shared_dispatch_stub_734(const GLint *v);
void APIENTRY shared_dispatch_stub_735(GLshort x, GLshort y, GLshort z);
void APIENTRY shared_dispatch_stub_736(const GLshort *v);
void APIENTRY shared_dispatch_stub_737(GLdouble x, GLdouble y, GLdouble z, GLdouble w);
void APIENTRY shared_dispatch_stub_738(const GLdouble *v);
void APIENTRY shared_dispatch_stub_739(GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void APIENTRY shared_dispatch_stub_740(const GLfloat *v);
void APIENTRY shared_dispatch_stub_741(GLint x, GLint y, GLint z, GLint w);
void APIENTRY shared_dispatch_stub_742(const GLint *v);
void APIENTRY shared_dispatch_stub_743(GLshort x, GLshort y, GLshort z, GLshort w);
void APIENTRY shared_dispatch_stub_744(const GLshort *v);
void APIENTRY shared_dispatch_stub_745(const GLenum *mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
void APIENTRY shared_dispatch_stub_746(const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
void APIENTRY shared_dispatch_stub_747(GLsizei n, const GLuint *fences);
void APIENTRY shared_dispatch_stub_748(GLuint fence);
void APIENTRY shared_dispatch_stub_749(GLsizei n, GLuint *fences);
void APIENTRY shared_dispatch_stub_750(GLuint fence, GLenum pname, GLint *params);
GLboolean APIENTRY shared_dispatch_stub_751(GLuint fence);
void APIENTRY shared_dispatch_stub_752(GLuint fence, GLenum condition);
GLboolean APIENTRY shared_dispatch_stub_753(GLuint fence);
GLboolean APIENTRY shared_dispatch_stub_754(GLsizei n, const GLuint *ids, GLboolean *residences);
void APIENTRY shared_dispatch_stub_755(GLenum target, GLuint program);
void APIENTRY shared_dispatch_stub_756(GLsizei n, const GLuint *programs);
void APIENTRY shared_dispatch_stub_757(GLenum target, GLuint id, const GLfloat *params);
void APIENTRY shared_dispatch_stub_758(GLsizei n, GLuint *programs);
void APIENTRY shared_dispatch_stub_759(GLenum target, GLuint index, GLenum pname, GLdouble *params);
void APIENTRY shared_dispatch_stub_760(GLenum target, GLuint index, GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_761(GLuint id, GLenum pname, GLubyte *program);
void APIENTRY shared_dispatch_stub_762(GLuint id, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_763(GLenum target, GLuint address, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_764(GLuint index, GLenum pname, GLvoid **pointer);
void APIENTRY shared_dispatch_stub_765(GLuint index, GLenum pname, GLdouble *params);
void APIENTRY shared_dispatch_stub_766(GLuint index, GLenum pname, GLfloat *params);
void APIENTRY shared_dispatch_stub_767(GLuint index, GLenum pname, GLint *params);
GLboolean APIENTRY shared_dispatch_stub_768(GLuint program);
void APIENTRY shared_dispatch_stub_769(GLenum target, GLuint id, GLsizei len, const GLubyte *program);
void APIENTRY shared_dispatch_stub_770(GLenum target, GLuint index, GLsizei num, const GLdouble *params);
void APIENTRY shared_dispatch_stub_771(GLenum target, GLuint index, GLsizei num, const GLfloat *params);
void APIENTRY shared_dispatch_stub_772(GLsizei n, const GLuint *ids);
void APIENTRY shared_dispatch_stub_773(GLenum target, GLuint address, GLenum matrix, GLenum transform);
void APIENTRY shared_dispatch_stub_774(GLuint index, GLdouble x);
void APIENTRY shared_dispatch_stub_775(GLuint index, const GLdouble *v);
void APIENTRY shared_dispatch_stub_776(GLuint index, GLfloat x);
void APIENTRY shared_dispatch_stub_777(GLuint index, const GLfloat *v);
void APIENTRY shared_dispatch_stub_778(GLuint index, GLshort x);
void APIENTRY shared_dispatch_stub_779(GLuint index, const GLshort *v);
void APIENTRY shared_dispatch_stub_780(GLuint index, GLdouble x, GLdouble y);
void APIENTRY shared_dispatch_stub_781(GLuint index, const GLdouble *v);
void APIENTRY shared_dispatch_stub_782(GLuint index, GLfloat x, GLfloat y);
void APIENTRY shared_dispatch_stub_783(GLuint index, const GLfloat *v);
void APIENTRY shared_dispatch_stub_784(GLuint index, GLshort x, GLshort y);
void APIENTRY shared_dispatch_stub_785(GLuint index, const GLshort *v);
void APIENTRY shared_dispatch_stub_786(GLuint index, GLdouble x, GLdouble y, GLdouble z);
void APIENTRY shared_dispatch_stub_787(GLuint index, const GLdouble *v);
void APIENTRY shared_dispatch_stub_788(GLuint index, GLfloat x, GLfloat y, GLfloat z);
void APIENTRY shared_dispatch_stub_789(GLuint index, const GLfloat *v);
void APIENTRY shared_dispatch_stub_790(GLuint index, GLshort x, GLshort y, GLshort z);
void APIENTRY shared_dispatch_stub_791(GLuint index, const GLshort *v);
void APIENTRY shared_dispatch_stub_792(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
void APIENTRY shared_dispatch_stub_793(GLuint index, const GLdouble *v);
void APIENTRY shared_dispatch_stub_794(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void APIENTRY shared_dispatch_stub_795(GLuint index, const GLfloat *v);
void APIENTRY shared_dispatch_stub_796(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
void APIENTRY shared_dispatch_stub_797(GLuint index, const GLshort *v);
void APIENTRY shared_dispatch_stub_798(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
void APIENTRY shared_dispatch_stub_799(GLuint index, const GLubyte *v);
void APIENTRY shared_dispatch_stub_800(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_801(GLuint index, GLsizei n, const GLdouble *v);
void APIENTRY shared_dispatch_stub_802(GLuint index, GLsizei n, const GLfloat *v);
void APIENTRY shared_dispatch_stub_803(GLuint index, GLsizei n, const GLshort *v);
void APIENTRY shared_dispatch_stub_804(GLuint index, GLsizei n, const GLdouble *v);
void APIENTRY shared_dispatch_stub_805(GLuint index, GLsizei n, const GLfloat *v);
void APIENTRY shared_dispatch_stub_806(GLuint index, GLsizei n, const GLshort *v);
void APIENTRY shared_dispatch_stub_807(GLuint index, GLsizei n, const GLdouble *v);
void APIENTRY shared_dispatch_stub_808(GLuint index, GLsizei n, const GLfloat *v);
void APIENTRY shared_dispatch_stub_809(GLuint index, GLsizei n, const GLshort *v);
void APIENTRY shared_dispatch_stub_810(GLuint index, GLsizei n, const GLdouble *v);
void APIENTRY shared_dispatch_stub_811(GLuint index, GLsizei n, const GLfloat *v);
void APIENTRY shared_dispatch_stub_812(GLuint index, GLsizei n, const GLshort *v);
void APIENTRY shared_dispatch_stub_813(GLuint index, GLsizei n, const GLubyte *v);
void APIENTRY shared_dispatch_stub_814(GLenum pname, GLfloat *param);
void APIENTRY shared_dispatch_stub_815(GLenum pname, GLint *param);
void APIENTRY shared_dispatch_stub_816(GLenum pname, const GLfloat *param);
void APIENTRY shared_dispatch_stub_817(GLenum pname, const GLint *param);
void APIENTRY shared_dispatch_stub_818(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod);
void APIENTRY shared_dispatch_stub_819(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod);
void APIENTRY shared_dispatch_stub_820(GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3, GLuint arg3Rep, GLuint arg3Mod);
void APIENTRY shared_dispatch_stub_821(void);
void APIENTRY shared_dispatch_stub_822(GLuint id);
void APIENTRY shared_dispatch_stub_823(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod);
void APIENTRY shared_dispatch_stub_824(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod);
void APIENTRY shared_dispatch_stub_825(GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3, GLuint arg3Rep, GLuint arg3Mod);
void APIENTRY shared_dispatch_stub_826(GLuint id);
void APIENTRY shared_dispatch_stub_827(void);
GLuint APIENTRY shared_dispatch_stub_828(GLuint range);
void APIENTRY shared_dispatch_stub_829(GLuint dst, GLuint coord, GLenum swizzle);
void APIENTRY shared_dispatch_stub_830(GLuint dst, GLuint interp, GLenum swizzle);
void APIENTRY shared_dispatch_stub_831(GLuint dst, const GLfloat *value);
void APIENTRY shared_dispatch_stub_832(GLenum pname, GLint param);
void APIENTRY shared_dispatch_stub_833(GLenum pname, const GLint *params);
void APIENTRY shared_dispatch_stub_834(GLenum face);
void APIENTRY shared_dispatch_stub_835(GLuint array);
void APIENTRY shared_dispatch_stub_836(GLsizei n, const GLuint *arrays);
void APIENTRY shared_dispatch_stub_837(GLsizei n, GLuint *arrays);
GLboolean APIENTRY shared_dispatch_stub_838(GLuint array);
void APIENTRY shared_dispatch_stub_839(GLuint id, GLsizei len, const GLubyte *name, GLdouble *params);
void APIENTRY shared_dispatch_stub_840(GLuint id, GLsizei len, const GLubyte *name, GLfloat *params);
void APIENTRY shared_dispatch_stub_841(GLuint id, GLsizei len, const GLubyte *name, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
void APIENTRY shared_dispatch_stub_842(GLuint id, GLsizei len, const GLubyte *name, const GLdouble *v);
void APIENTRY shared_dispatch_stub_843(GLuint id, GLsizei len, const GLubyte *name, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void APIENTRY shared_dispatch_stub_844(GLuint id, GLsizei len, const GLubyte *name, const GLfloat *v);
void APIENTRY shared_dispatch_stub_845(GLuint index);
void APIENTRY shared_dispatch_stub_846(void);
void APIENTRY shared_dispatch_stub_847(GLenum func, GLclampx ref);
void APIENTRY shared_dispatch_stub_848(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY shared_dispatch_stub_849(GLclampx depth);
void APIENTRY shared_dispatch_stub_850(GLenum plane, const GLfixed *equation);
void APIENTRY shared_dispatch_stub_851(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY shared_dispatch_stub_852(GLclampx zNear, GLclampx zFar);
void APIENTRY shared_dispatch_stub_853(GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_854(GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_855(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY shared_dispatch_stub_856(GLenum plane, GLfixed *equation);
void APIENTRY shared_dispatch_stub_857(GLenum pname, GLfixed *params);
void APIENTRY shared_dispatch_stub_858(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY shared_dispatch_stub_859(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY shared_dispatch_stub_860(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY shared_dispatch_stub_861(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY shared_dispatch_stub_862(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY shared_dispatch_stub_863(GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_864(GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_865(GLenum light, GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_866(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_867(GLfixed width);
void APIENTRY shared_dispatch_stub_868(const GLfixed *m);
void APIENTRY shared_dispatch_stub_869(GLenum face, GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_870(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_871(const GLfixed *m);
void APIENTRY shared_dispatch_stub_872(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY shared_dispatch_stub_873(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY shared_dispatch_stub_874(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY shared_dispatch_stub_875(GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_876(GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_877(GLfixed size);
void APIENTRY shared_dispatch_stub_878(GLfixed factor, GLfixed units);
void APIENTRY shared_dispatch_stub_879(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY shared_dispatch_stub_880(GLclampx value, GLboolean invert);
void APIENTRY shared_dispatch_stub_881(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY shared_dispatch_stub_882(GLenum target, GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_883(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_884(GLenum coord, GLenum pname, GLint param);
void APIENTRY shared_dispatch_stub_885(GLenum coord, GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_886(GLenum target, GLenum pname, GLfixed param);
void APIENTRY shared_dispatch_stub_887(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY shared_dispatch_stub_888(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY shared_dispatch_stub_889(GLenum plane, const GLfloat *equation);
void APIENTRY shared_dispatch_stub_890(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY shared_dispatch_stub_891(GLenum plane, GLfloat *equation);
void APIENTRY shared_dispatch_stub_892(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY shared_dispatch_stub_893(GLclampd zmin, GLclampd zmax);
void APIENTRY shared_dispatch_stub_894(GLenum modeRGB, GLenum modeA);
void APIENTRY shared_dispatch_stub_895(GLenum target, GLuint framebuffer);
void APIENTRY shared_dispatch_stub_896(GLenum target, GLuint renderbuffer);
GLenum APIENTRY shared_dispatch_stub_897(GLenum target);
void APIENTRY shared_dispatch_stub_898(GLsizei n, const GLuint *framebuffers);
void APIENTRY shared_dispatch_stub_899(GLsizei n, const GLuint *renderbuffers);
void APIENTRY shared_dispatch_stub_900(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
void APIENTRY shared_dispatch_stub_901(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
void APIENTRY shared_dispatch_stub_902(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
void APIENTRY shared_dispatch_stub_903(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
void APIENTRY shared_dispatch_stub_904(GLsizei n, GLuint *framebuffers);
void APIENTRY shared_dispatch_stub_905(GLsizei n, GLuint *renderbuffers);
void APIENTRY shared_dispatch_stub_906(GLenum target);
void APIENTRY shared_dispatch_stub_907(GLenum target, GLenum attachment, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_908(GLenum target, GLenum pname, GLint *params);
GLboolean APIENTRY shared_dispatch_stub_909(GLuint framebuffer);
GLboolean APIENTRY shared_dispatch_stub_910(GLuint renderbuffer);
void APIENTRY shared_dispatch_stub_911(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
void APIENTRY shared_dispatch_stub_912(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
void APIENTRY shared_dispatch_stub_913(GLenum target, GLenum pname, GLint param);
void APIENTRY shared_dispatch_stub_914(GLenum target, GLintptr offset, GLsizeiptr size);
void APIENTRY shared_dispatch_stub_915(GLuint program, GLuint colorNumber, const GLchar *name);
GLint APIENTRY shared_dispatch_stub_916(GLuint program, const GLchar *name);
void APIENTRY shared_dispatch_stub_917(GLuint program, GLint location, GLuint *params);
void APIENTRY shared_dispatch_stub_918(GLuint index, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_919(GLuint index, GLenum pname, GLuint *params);
void APIENTRY shared_dispatch_stub_920(GLint location, GLuint x);
void APIENTRY shared_dispatch_stub_921(GLint location, GLsizei count, const GLuint *value);
void APIENTRY shared_dispatch_stub_922(GLint location, GLuint x, GLuint y);
void APIENTRY shared_dispatch_stub_923(GLint location, GLsizei count, const GLuint *value);
void APIENTRY shared_dispatch_stub_924(GLint location, GLuint x, GLuint y, GLuint z);
void APIENTRY shared_dispatch_stub_925(GLint location, GLsizei count, const GLuint *value);
void APIENTRY shared_dispatch_stub_926(GLint location, GLuint x, GLuint y, GLuint z, GLuint w);
void APIENTRY shared_dispatch_stub_927(GLint location, GLsizei count, const GLuint *value);
void APIENTRY shared_dispatch_stub_928(GLuint index, GLint x);
void APIENTRY shared_dispatch_stub_929(GLuint index, const GLint *v);
void APIENTRY shared_dispatch_stub_930(GLuint index, GLuint x);
void APIENTRY shared_dispatch_stub_931(GLuint index, const GLuint *v);
void APIENTRY shared_dispatch_stub_932(GLuint index, GLint x, GLint y);
void APIENTRY shared_dispatch_stub_933(GLuint index, const GLint *v);
void APIENTRY shared_dispatch_stub_934(GLuint index, GLuint x, GLuint y);
void APIENTRY shared_dispatch_stub_935(GLuint index, const GLuint *v);
void APIENTRY shared_dispatch_stub_936(GLuint index, GLint x, GLint y, GLint z);
void APIENTRY shared_dispatch_stub_937(GLuint index, const GLint *v);
void APIENTRY shared_dispatch_stub_938(GLuint index, GLuint x, GLuint y, GLuint z);
void APIENTRY shared_dispatch_stub_939(GLuint index, const GLuint *v);
void APIENTRY shared_dispatch_stub_940(GLuint index, const GLbyte *v);
void APIENTRY shared_dispatch_stub_941(GLuint index, GLint x, GLint y, GLint z, GLint w);
void APIENTRY shared_dispatch_stub_942(GLuint index, const GLint *v);
void APIENTRY shared_dispatch_stub_943(GLuint index, const GLshort *v);
void APIENTRY shared_dispatch_stub_944(GLuint index, const GLubyte *v);
void APIENTRY shared_dispatch_stub_945(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
void APIENTRY shared_dispatch_stub_946(GLuint index, const GLuint *v);
void APIENTRY shared_dispatch_stub_947(GLuint index, const GLushort *v);
void APIENTRY shared_dispatch_stub_948(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY shared_dispatch_stub_949(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
void APIENTRY shared_dispatch_stub_950(GLuint buf, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
void APIENTRY shared_dispatch_stub_951(GLenum target, GLuint index);
void APIENTRY shared_dispatch_stub_952(GLenum target, GLuint index);
void APIENTRY shared_dispatch_stub_953(GLenum value, GLuint index, GLboolean *data);
void APIENTRY shared_dispatch_stub_954(GLenum value, GLuint index, GLint *data);
GLboolean APIENTRY shared_dispatch_stub_955(GLenum target, GLuint index);
void APIENTRY shared_dispatch_stub_956(GLint r, GLint g, GLint b, GLint a);
void APIENTRY shared_dispatch_stub_957(GLuint r, GLuint g, GLuint b, GLuint a);
void APIENTRY shared_dispatch_stub_958(GLenum target, GLenum pname, GLint *params);
void APIENTRY shared_dispatch_stub_959(GLenum target, GLenum pname, GLuint *params);
void APIENTRY shared_dispatch_stub_960(GLenum target, GLenum pname, const GLint *params);
void APIENTRY shared_dispatch_stub_961(GLenum target, GLenum pname, const GLuint *params);
void APIENTRY shared_dispatch_stub_962(GLuint query, GLenum mode);
void APIENTRY shared_dispatch_stub_963(void);
void APIENTRY shared_dispatch_stub_964(GLenum mode);
void APIENTRY shared_dispatch_stub_965(GLenum target, GLuint index, GLuint buffer);
void APIENTRY shared_dispatch_stub_966(GLenum target, GLuint index, GLuint buffer, GLintptr offset);
void APIENTRY shared_dispatch_stub_967(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
void APIENTRY shared_dispatch_stub_968(void);
void APIENTRY shared_dispatch_stub_969(GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLsizei *size, GLenum *type, GLchar *name);
void APIENTRY shared_dispatch_stub_970(GLuint program, GLsizei count, const char **varyings, GLenum bufferMode);
void APIENTRY shared_dispatch_stub_971(GLenum mode);
void APIENTRY shared_dispatch_stub_972(GLenum target, GLenum pname, GLvoid **params);
void APIENTRY shared_dispatch_stub_973(GLenum target, GLsizei length, GLvoid *pointer);
void APIENTRY shared_dispatch_stub_974(GLenum objectType, GLuint name, GLenum pname, GLint *value);
GLenum APIENTRY shared_dispatch_stub_975(GLenum objectType, GLuint name, GLenum option);
GLenum APIENTRY shared_dispatch_stub_976(GLenum objectType, GLuint name, GLenum option);
void APIENTRY shared_dispatch_stub_977(GLuint program);
GLuint APIENTRY shared_dispatch_stub_978(GLenum type, const GLchar *string);
void APIENTRY shared_dispatch_stub_979(GLenum type, GLuint program);
void APIENTRY shared_dispatch_stub_980(void);
void APIENTRY shared_dispatch_stub_981(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY shared_dispatch_stub_982(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY shared_dispatch_stub_983(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY shared_dispatch_stub_984(GLuint id, GLenum pname, GLint64EXT *params);
void APIENTRY shared_dispatch_stub_985(GLuint id, GLenum pname, GLuint64EXT *params);
void APIENTRY shared_dispatch_stub_986(GLenum target, GLvoid *writeOffset);
void APIENTRY shared_dispatch_stub_987(GLenum target, GLvoid *writeOffset);
#undef MAPI_TMP_DEFINES
#endif /* MAPI_TMP_DEFINES */

#ifdef MAPI_TMP_TABLE
#define MAPI_TABLE_NUM_STATIC 988
