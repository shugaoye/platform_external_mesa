...
void APIENTRY gl_dispatch_stub_651(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY gl_dispatch_stub_652(const GLfloat *coords);
void APIENTRY gl_dispatch_stub_653(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY gl_dispatch_stub_654(const GLint *coords);
void APIENTRY gl_dispatch_stub_655(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY gl_dispatch_stub_656(const GLshort *coords);
void APIENTRY gl_dispatch_stub_657(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY gl_dispatch_stub_658(const GLfixed *coords);
void APIENTRY gl_dispatch_stub_659(GLenum type, GLsizei stride, const GLvoid *pointer);
...
GLbitfield APIENTRY gl_dispatch_stub_666(GLfixed *mantissa, GLint *exponent);
...
void APIENTRY gl_dispatch_stub_847(GLenum func, GLclampx ref);
void APIENTRY gl_dispatch_stub_848(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY gl_dispatch_stub_849(GLclampx depth);
void APIENTRY gl_dispatch_stub_850(GLenum plane, const GLfixed *equation);
void APIENTRY gl_dispatch_stub_851(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY gl_dispatch_stub_852(GLclampx zNear, GLclampx zFar);
void APIENTRY gl_dispatch_stub_853(GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_854(GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_855(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY gl_dispatch_stub_856(GLenum plane, GLfixed *equation);
void APIENTRY gl_dispatch_stub_857(GLenum pname, GLfixed *params);
void APIENTRY gl_dispatch_stub_858(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY gl_dispatch_stub_859(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY gl_dispatch_stub_860(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY gl_dispatch_stub_861(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY gl_dispatch_stub_862(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY gl_dispatch_stub_863(GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_864(GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_865(GLenum light, GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_866(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_867(GLfixed width);
void APIENTRY gl_dispatch_stub_868(const GLfixed *m);
void APIENTRY gl_dispatch_stub_869(GLenum face, GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_870(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_871(const GLfixed *m);
void APIENTRY gl_dispatch_stub_872(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY gl_dispatch_stub_873(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY gl_dispatch_stub_874(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY gl_dispatch_stub_875(GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_876(GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_877(GLfixed size);
void APIENTRY gl_dispatch_stub_878(GLfixed factor, GLfixed units);
void APIENTRY gl_dispatch_stub_879(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY gl_dispatch_stub_880(GLclampx value, GLboolean invert);
void APIENTRY gl_dispatch_stub_881(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY gl_dispatch_stub_882(GLenum target, GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_883(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_884(GLenum coord, GLenum pname, GLint param);
void APIENTRY gl_dispatch_stub_885(GLenum coord, GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_886(GLenum target, GLenum pname, GLfixed param);
void APIENTRY gl_dispatch_stub_887(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY gl_dispatch_stub_888(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY gl_dispatch_stub_889(GLenum plane, const GLfloat *equation);
void APIENTRY gl_dispatch_stub_890(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY gl_dispatch_stub_891(GLenum plane, GLfloat *equation);
void APIENTRY gl_dispatch_stub_892(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
